...
export default class CreateUserPage extends CustomBasicPageLogged{
    ...
    constructor(props: any) {
        ...
        this.state = {
            ...this.state,
            initialUsername: props.username || "",
            formError: "",
            ...
            componentName: "Modify user | TI-Shop",
        }
        handleObtainUser(this);
    }
    ...
    render() {
        ...
        let msgError = obtainTextTranslated["requestErrors"][this.state.requestErrors.get('modifyUserError')]
